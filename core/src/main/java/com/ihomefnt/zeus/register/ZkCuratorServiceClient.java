...
public class ZkCuratorServiceClient {
    ...
    public ZkCuratorServiceClient(CuratorFramework client) throws Exception {
        this.serviceCacheExecutors = Executors.newFixedThreadPool(30, this.namedThreadFactory);
        this.client =client;
        this.basePath = ZeusServiceConfig.getBasePath();
    ...
    public void serviceInit() {
        try {
            ...
            for (String serviceName : serviceNames) {
                if (serviceName.contains(ZeusServiceConfig.getServiceGroup())) {
